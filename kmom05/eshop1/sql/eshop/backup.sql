...
INSERT INTO `log_products` VALUES (1,1,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 1 NAME: Bikini med långärmad top'),(2,2,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 2 NAME: Baddräkt i ljusblått'),(3,3,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 3 NAME: Bikini'),(4,4,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 4 NAME: Baddräkt'),(5,5,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 5 NAME: Kimono'),(6,6,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 6 NAME: Kimono'),(7,7,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 7 NAME: Beach robe'),(8,8,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 8 NAME: Hoodie'),(9,9,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 9 NAME: Hoodie'),(10,10,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 10 NAME: Hoodie'),(11,11,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 11 NAME: Boardshorts'),(12,12,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 12 NAME: Boardshorts retro stil'),(13,13,'2020-09-15 20:27:26','TRIGGER - New product was registered.','Empty','New product -> ID: 13 NAME: Polotröja');
...
CREATE TABLE `orders` (
  ...
  `picked` timestamp NULL DEFAULT NULL,
...
--
-- Temporary table structure for view `v_shelves`
--

DROP TABLE IF EXISTS `v_shelves`;
/*!50001 DROP VIEW IF EXISTS `v_shelves`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_shelves` (
  `id` tinyint NOT NULL,
  `position` tinyint NOT NULL,
  `product` tinyint NOT NULL,
  `amount` tinyint NOT NULL
...
begin
    ...
    elseif time_shipped is not null then
        return 'Skickad';
    elseif time_picked is not null then
        return 'Plockad';
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `payment_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` FUNCTION `payment_status`(
...
begin
    if time_deleted is not null then
        return 'Makulerad';
    elseif time_payed is not null then
        return 'Betalad';
    elseif time_payed is null then
        return 'Ej betald';
    end if;
    return 'Status okänd';
end ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `picked_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` FUNCTION `picked_status`(
    time_picked timestamp
) RETURNS char(10) CHARSET utf8mb4
    DETERMINISTIC
begin
    if time_picked is not null then
        return "Plockad";
    elseif time_picked is null then
        return 'Ej plockad';
    end if;
    return 'Status okänd';
end ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_product_from_inventory_position` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` PROCEDURE `get_product_from_inventory_position`(
    input_position varchar(8)
)
begin
select amount from v_inventory
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `pick_order` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` PROCEDURE `pick_order`(
    order_id int
)
begin
update orders
    set `picked` = current_timestamp
    where id = order_id;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`user`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_orders` AS select `o`.`id` AS `id`,`o`.`customer` AS `customer`,concat(`c`.`firstname`,' ',`c`.`lastname`) AS `name`,count(`pl`.`order`) AS `rows`,`o`.`created` AS `created`,`o`.`updated` AS `updated`,`picked_status`(`o`.`picked`) AS `picked`,`o`.`picked` AS `picked_date`,`o`.`shipped` AS `shipped`,`payment_status`(`o`.`payment`,`o`.`deleted`) AS `payment`,`o`.`payment` AS `payment_date`,`o`.`deleted` AS `deleted`,`order_status`(`o`.`created`,`o`.`updated`,`o`.`ordered`,`o`.`picked`,`o`.`shipped`,`o`.`deleted`) AS `status` from ((`orders` `o` join `customers` `c` on((`o`.`customer` = `c`.`id`))) left join `picking_lists` `pl` on((`o`.`id` = `pl`.`order`))) group by `o`.`id` order by `o`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`user`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_picking_lists` AS select `pl`.`id` AS `id`,`pl`.`order` AS `order`,`pl`.`index` AS `index`,`pl`.`product` AS `product`,`p`.`name` AS `name`,`p`.`info` AS `info`,`pl`.`amount` AS `amount`,group_concat(distinct concat(`i`.`section`,'-',`i`.`position`,'-',`i`.`level`) separator ', ') AS `position`,sum(distinct `i`.`amount`) AS `stored`,(`pl`.`amount` * `p`.`price`) AS `price` from ((`picking_lists` `pl` join `products` `p` on((`pl`.`product` = `p`.`id`))) join `inventory` `i` on((`p`.`id` = `i`.`product`))) group by `pl`.`id`,`pl`.`product`,`i`.`product` order by `pl`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`user`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_shelves` AS select `inventory`.`id` AS `id`,concat(`inventory`.`section`,'-',`inventory`.`position`,'-',`inventory`.`level`) AS `position`,`inventory`.`product` AS `product`,`inventory`.`amount` AS `amount` from `inventory` order by concat(`inventory`.`section`,'-',`inventory`.`position`,'-',`inventory`.`level`),`inventory`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-09-15 22:33:07
