...
CREATE TABLE `invoices` (
  ...
  CONSTRAINT `invoices_ibfk_3` FOREIGN KEY (`product_list`) REFERENCES `picking_list` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `log_products` VALUES (1,1,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 1 NAME: Badbrallor'),(2,2,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 2 NAME: Bikini'),(3,3,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 3 NAME: Baddräkt'),(4,4,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 4 NAME: Baddräkt'),(5,5,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 5 NAME: Shorts'),(6,6,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 6 NAME: T-Shirt'),(7,7,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 7 NAME: T-Shirt'),(8,8,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 8 NAME: Hoodie'),(9,9,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 9 NAME: Hoodie'),(10,10,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 10 NAME: Hoodie'),(11,11,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 11 NAME: Jeans'),(12,12,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 12 NAME: Chinos'),(13,13,'19:19:19','2020-08-27','TRIGGER - New product was registered.','Empty','New product -> ID: 13 NAME: Polotröja');
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`picking_list`) REFERENCES `picking_list` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `picking_list` (
  ...
  CONSTRAINT `picking_list_ibfk_1` FOREIGN KEY (`id`) REFERENCES `products` (`id`),
  CONSTRAINT `picking_list_ibfk_2` FOREIGN KEY (`position`) REFERENCES `inventory` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `picking_list`
--

LOCK TABLES `picking_list` WRITE;
/*!40000 ALTER TABLE `picking_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `picking_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-08-27 19:19:19
