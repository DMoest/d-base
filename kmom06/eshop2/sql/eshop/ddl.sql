...
drop procedure if exists get_product_from_inventory_position;
...
drop procedure if exists pick_order;
...
drop function if exists picked_status;
drop function if exists payment_status;
...
delimiter $$
create function payment_status(
...
select
    ...
    picked_status(o.picked) as `picked`,
    o.picked as `picked_date`,
    o.shipped as `shipped`,
    payment_status(o.payment, o.deleted) as `payment`,
    o.payment as `payment_date`,
    o.deleted as `deleted`,
    order_status(o.created, o.updated, o.ordered, o.picked, o.shipped, o.deleted) as `status`
from orders as o
    join customers as c
        on o.customer = c.id
...
-- Get a product from a position in inventory:
delimiter $$
create procedure get_product_from_inventory_position(
