...
...
Examination 28 augusti 2020
=======================================

Detta är den individuella examinationen som är en del av kmom10.

<!--
Du kan läsa detta dokumentet i webbläsaren via länken "[Examination 28 augusti 2020](https://dbwebb.se/kurser/databas-v1/kmom10/tentamen/sapo2)"
-->
...
1. Skapa routen `/exam/show` som visar en rapport från tabellen `logg` tillsammans med organisationens namn, personens fulla namn och nivå på brottskategorin.
...
1. Skapa kommandot `show` som visar en snygg tabell med samma rapport som kan ses i webbklienten via länken `/exam/show`.
