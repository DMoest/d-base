...
router.get("/product", async (req, res) => {
    ...
    let data = {
        ...
        res: await myFunctions.getAllProducts()
    };
...
router.get("/createOrder/:id", async (req, res) => {
    ...
    let data = {
        ...
        order: id,
        res: await myFunctions.showProductListFromInventories(id)
    };
...
router.get("/orders-selectProducts/:id", async (req, res) => {
    ...
    let data = {
        ...
        order: id,
        customer: await myFunctions.getCustomerFromOrder(id),
        res: await myFunctions.showProductListFromInventories()
    };
...
router.post("/order/:order/picklist", urlencodedParser, async (req, res) => {
    console.log("* PICKLIST ROUTE (POST)");
...
// Picked picklist for order
router.post("/order/:order/picklist/picked", urlencodedParser, async (req, res) => {
    console.log("* PICKED PICKLIST ROUTE (POST)");

    let order = req.params.order;

    await myFunctions.pickedOrder(order);
...
router.post("/:order/shipOrder/", urlencodedParser, async (req, res) => {
    // console.log("* ORDER - SHIP THE ORDER (POST)");
